                                  ...
                                  VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setFilterOffset(offset, [callback, userdata](core::ErrorCode code) {
                           ...
                           VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setFilter(low, high, (core::FilterShape)filter_shape,
                              ...
                              VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setCwOffset(offset, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                               ...
                               VioletFloatCallback callback, void* userdata)
{
    ...
    vfo->getSignalPwr([callback, userdata](core::ErrorCode code, float power) {
                                  ...
                                  VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setNoiseBlanker(id, on, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                                    ...
                                    VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setNoiseBlankerThreshold(id, threshold,
                                  [callback, userdata](core::ErrorCode code) {
                                      callback(code, userdata);
                                  });
}
                              ...
                              VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setSqlLevel(level_db, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                              ...
                              VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setSqlAlpha(alpha, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                           ...
                           VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setAgcOn(on, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                             ...
                             VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setAgcHang(on, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                                  ...
                                  VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setAgcThreshold(threshold, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                              ...
                              VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setAgcSlope(slope, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                              ...
                              VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setAgcDecay(decay, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                                    ...
                                    VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setAgcManualGain(gain, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                              ...
                              VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setFmMaxDev(maxdev, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                              ...
                              VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setFmDeemph(tau, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                           ...
                           VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setAmDcr(enable, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                                ...
                                VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setAmSyncDcr(enable, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                                   ...
                                   VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setAmSyncPllBw(bw, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                                     ...
                                     void* userdata)
{
    ...
    vfo->stopAudioRecording([callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                               ...
                               VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->setAudioGain(gain, [callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                             ...
                             void* userdata)
{
    ...
    vfo->stopSniffer([callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                                 ...
                                 void* userdata)
{
    ...
    vfo->getSnifferData(
        data, size,
        [callback, userdata](core::ErrorCode code, float* data, int size) {
                             ...
                             VioletRdsDataCallback callback, void* userdata)
{
    ...
    vfo->getRdsData(
        [callback, userdata](core::ErrorCode code, std::string data, int type) {
                                  ...
                                  VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->startRdsDecoder([callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                                 ...
                                 VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->stopRdsDecoder([callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                                 ...
                                 VioletVoidCallback callback, void* userdata)
{
    ...
    vfo->resetRdsParser([callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
                                              ...
                                              VioletDemod demod)
{
    ...
    auto range = vfo->getFilterRange((core::Demod)demod);
                            ...
                            void* userdata)
{
    ...
    vfo->synchronize([callback, userdata](core::ErrorCode code) {
        callback(code, userdata);
    });
}
...
VioletConnection* violet_vfo_subscribe(VioletVfo* vfo_erased,
                                       VioletVfoEventCallback callback,
                                       void* userdata)
{
    auto vfo = static_cast<core::AsyncVfoIface*>(vfo_erased);

    Connection connection = vfo->subscribe([=](const core::VfoEvent& ev) {
        core::CEvent c_event(ev);
        callback(c_event.inner_as_vfo_event(), userdata);
    });
